...
class TestPipeline(unittest.TestCase):
    ...
    def test_event_triggers(self):
        ...
        self.assertEqual(9, len(event_trigger_examples))
        ...
        self.assertEqual(4, len(merged_trigger_examples))
    ...
    def test_event_roles(self):
        ...
        self.assertEqual(165, len(event_role_examples))
        ...
        self.assertEqual(4, len(merged_role_examples))
